...
class TestRegistration:
    ...
    @pytest.mark.parametrize("name, middle_name, last_name, email, password",
    ...
    def test_valid_authorization(self, name, middle_name, last_name, email, password):
        login_page = LoginPage(self.driver)
        main_page = MainPage(self.driver)
        registration_page = RegistrationPage(self.driver)

        login_page.get_registration()
        registration_page.create_user(name, middle_name, last_name, email, password)
